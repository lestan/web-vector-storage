import { IWVSDocument } from '../types/IWVSDocument';
import { IWVSFilterCriteria, IWVSFilterOptions } from '../types/IWVSFilterOptions';

export function filterDocuments(documents: Array<IWVSDocument<any>>, filterOptions?: IWVSFilterOptions): Array<IWVSDocument<any>> {
...
function matchesCriteria(document: IWVSDocument<any>, criteria: IWVSFilterCriteria): boolean {
